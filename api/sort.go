...
func GetFormatedDuration(duration time.Duration) string {
	if math.Trunc(duration.Hours()/24/365) != 0 {
		return strconv.Itoa(int(math.Trunc(duration.Hours()/24/365))) + "y. " + strconv.Itoa(int(math.Trunc(duration.Hours()/24/30))-(int(math.Trunc(duration.Hours()/24/365))*12)) + "m. ago"
	} else if math.Trunc(duration.Hours()/24/30) != 0 {
		return strconv.Itoa(int(math.Trunc(duration.Hours()/24/30))) + "m. " + strconv.Itoa(int(math.Trunc(math.Trunc(duration.Hours()/24/7)-(math.Trunc(duration.Hours()/24/30))*(30/7)))) + "w. ago"
